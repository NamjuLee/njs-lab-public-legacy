"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[24358],{35002:function(e,t,n){n.d(t,{Bt:function(){return su},JU:function(){return iD},PL:function(){return si},ad:function(){return iL},hJ:function(){return ib},oe:function(){return so},pl:function(){return ss},r7:function(){return sa}});var r,i,s,a,o=n(48885),l=n(42680),u=n(19053),h=n(71028),c=n(76552),d=n(4575);n(20357);var f=n(86300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ty{constructor(){this._=void 0}}function tv(e,t){return e instanceof tC?eA(t)||t&&"doubleValue"in t?t:{integerValue:0}:null}class tw extends ty{}class t_ extends ty{constructor(e){super(),this.elements=e}}function tE(e,t){let n=tN(t);for(let t of e.elements)n.some(e=>eE(e,t))||n.push(t);return{arrayValue:{values:n}}}class tT extends ty{constructor(e){super(),this.elements=e}}function tI(e,t){let n=tN(t);for(let t of e.elements)n=n.filter(e=>!eE(e,t));return{arrayValue:{values:n}}}class tC extends ty{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function tS(e){return ed(e.integerValue||e.doubleValue)}function tN(e){return ek(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rB(n,new iu({next:n=>{t.enqueueAndForget(()=>rF(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return rO(e,s)})(await ip(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sn(t,r,e,n)))}function ss(e,t,n){var r;e=iI(e,iA);let i=iI(e.firestore,ix),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sl(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,n,i);iZ("Data must be an object, but it was:",l,r);let u=iX(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i0(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i3(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iz(new eM(u),a,o)})(ij(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tb.none())])}function sa(e,t,n,...r){e=iI(e,iA);let i=iI(e.firestore,ix),s=ij(i);return sl(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iF?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i0(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i0(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i3(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof iW)u.push(t);else{let e=iY(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new i$(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);iZ("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i2(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof iW)s.push(o);else{let e=iY(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new i$(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tb.exists(!0))])}function so(e){return sl(iI(e.firestore,ix),[new tq(e._key,tb.none())])}function sl(e,t){return function(e,t){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>r0(await ig(e).then(e=>e.syncEngine),t,n)),n.promise}(iV(e),t)}function su(){return new iH("serverTimestamp")}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new ix(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);